      ...
      <aside className="relative hidden lg:block overflow-hidden">
        ...
        <div className="relative h-full p-14 flex flex-col justify-between">
          ...
          <div className="max-w-md">
            <h2 className="font-display text-5xl leading-tight font-semibold text-foreground">
              A quieter way to{" "}
              <span className="italic text-primary">glow</span>.
            </h2>
            <p className="mt-5 text-foreground/70 leading-relaxed">
              Join a community that treats beauty as ritual — book with
              salons you love, keep your history tidy, and rediscover the
              joy of self-care.
            </p>
            ...
            <div className="mt-10 bg-white/80 backdrop-blur rounded-3xl p-6 border border-white/80 shadow-soft max-w-sm">
              ...
              <p className="mt-3 text-sm leading-relaxed text-foreground/85">
                &ldquo;I finally stopped juggling DMs to book my balayage.
                Salonify feels like a little app that understands me.&rdquo;
              </p>
              <div className="mt-4 flex items-center gap-3">
                <Avatar name="Mila Jovanović" size={36} />
                <div>
                  <p className="text-sm font-semibold">Mila Jovanović</p>
                  <p className="text-xs text-muted">Client since 2023</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <p className="text-xs text-muted">
            © {new Date().getFullYear()} Salonify — crafted with intention.
          </p>
        </div>
      </aside>
